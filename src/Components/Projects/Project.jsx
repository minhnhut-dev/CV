            ...
            <div className="project_section" key={index}>
              ...
              <div className="project_section-left">
                ...
                <div className="project_button">
                  <Button btnStyle='outline' btnText='Source' btnLink={project.srcCode} style={{ '--color-project': project.color }} />
                  <Button btnStyle='outline' btnText='Demo' btnLink={project.preview} style={{ '--color-project': project.color }} />
                </div>
              </div>
              ...
              <div className="project_section-right">
                <div className="project_card-wrap" style={{ '--color-project': project.color }}>
                  <div className="project_card" onClick={() => handleCard(index)}  >
                    <div className={activeCard === index ? "project_card-inner active" : "project_card-inner"}>
                      <div className="project_card-front">
                        <img src={project.src} alt="" />
                      </div>
                      <div className="project_card-back">
                        <p>{project.desc.map((desc, index) => {
                          return (<>
                            <span ><BsDot/>{desc}</span><br />
                          </>
                          )
                        })}</p>
                      </div>
